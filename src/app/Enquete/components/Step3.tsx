...
const Step3: FC<Step3Props> = ({ onNext }) => {
    ...
    <div className="max-w-6xl p-4 mx-auto">
      ...
      <div className="flex">
        ...
        <div className="w-4/6 pl-4">
          <div className="mb-6">
            <h2 className="mb-2 text-lg text-gray-600">Utilisation du portail</h2>
            <span className="text-3xl font-bold">
              Trouvez-vous facilement les informations que vous cherchez ?
            </span>
          </div>
