    ...
    return (
        <>
            <section className="mt-[150px] relative px-4 lg:px-[100px]">
                <div className="flex flex-col justify-between relative z-10 lg:flex-row md:flex-row lg:pt-10">
            ...
            <section className="mb-40">
                <div className="px-4 lg:px-[100px] flex flex-col gap-5 justify-center items-center">
                    ...
                    <p className="text-gray-500 text-center max-w-xl lg:max-w-5xl">Notre portail centralisé à tous les sénégalais une solution simple et rapide pour toutes vos démarches administratives. Suivez en temps réel l'avancement de vos demandes et bénéficiez d'un service personnalisé. Tous vos services sont accessibles en ligne, 24h/24 et 7j/7. Découvrez comment nous vous facilitons la vie au quotidien.</p>
            ...
            <section className="h-auto bg-[#085F28] py-20 mb-20">
                <div className="text-white flex flex-col justify-center items-center space-y-10 px-4">
                    <h2 className="font-bold text-3xl lg:text-4xl text-center">Découvrez tous les services disponibles</h2>
